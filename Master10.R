...
load("F:/cedlas/Base monografia/Base Educ/Base hogares/Base1.Rdata")
load("F:/cedlas/Base monografia/Base Educ/Base hogares/Base2.Rdata")
load("F:/cedlas/Base monografia/Base Educ/Base hogares/Base3.Rdata")
load("F:/cedlas/Base monografia/Base Educ/Base hogares/Base4.Rdata")

# Uno todas las bases
bT<-rbind(b1, b2, b3[,-32], b4[,-32])
rm(b1,b2,b3,b4)
...
# Me quedo con las familais con Ingreso per cápita positivo
...
bT_sd<-mutate(bT_sd, ila=ifelse(is.na(ila_m)==TRUE, 
                                ila_f, ila_m))
...
drop<-c("nivel_m","nivel_f","part_m","part_f", "ila_m", "ila_f")
bT_sd<-bT_sd[,!(names(bT_sd) %in% drop)]
rm(drop)
...
names(tab1_cs)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(tab1_sd)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(tab4_cs)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(tab4_sd)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
...
tab1<-tab1[,2:11]/mean_ipcfr1
tab4<-tab4[,2:11]/mean_ipcfr4
...
# Uno ambas tablas y reemplazo datos faltantes por ceros 
# Primero renombro las columnas de ambas
names(ftab1_cs)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(ftab1_sd)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(ftab4_cs)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
names(ftab4_sd)<-c("Grupo", "D1", "D2", "Q3", "D4", "D5", "D6", "D7", "D8", "D9", "D10")
...
write.table(format(tab1, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/r_ftotinc_adj10_1.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(tab4, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/r_ftotinc_adj10_4.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(ftab1, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/f_ftotinc_adj10_1.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(ftab4, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/f_ftotinc_adj10_4.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
...
write.table(iesp1,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/wife_share10_1.txt",sep="\t", col.names = F, row.names = F)
write.table(iesp4,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/wife_share10_4.txt",sep="\t", col.names = F, row.names = F)

# Genero ingresos laborales totales y calculo deciles
...
Per1_cs<-mutate(Per1_cs, cuant_ilat1=ntile(ila_t,10))
Per4_cs<-mutate(Per4_cs, cuant_ilat4=ntile(ila_t,10))
Per1_cs<-mutate(Per1_cs, cuant_ilad1=gcuan(ila_t,ncuan=10))
Per4_cs<-mutate(Per4_cs, cuant_ilad4=gcuan(ila_t,ncuan=10))
cuant_ilam1<-gcuan(Per1_cs$ila_t,ncuan=10)
cuant_ilam4<-gcuan(Per4_cs$ila_t,ncuan=10)
Per1_cs<-cbind(Per1_cs,cuant_ilam1)
Per4_cs<-cbind(Per4_cs,cuant_ilam4)

# participación del ingreso y participación laboral por deciles del
...
write.table(part_esp,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/income_share_wife10.txt",sep="\t", col.names = F, row.names = F)
write.table(part_wrk,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/lfp_wife10.txt",sep="\t", col.names = F, row.names = F)

#grupos<-c(levels(grupos_cs),levels(grupos_sd))
#write.table(grupos,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/types2.txt",sep="\t", col.names = F, row.names = F)
