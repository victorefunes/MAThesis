...
bT<-subset(bT, select=c(X, ila_m, ila_f, ila_mr, ila_fr, itf, ipcfc, nivel_m,
                        nivel_f,part_m, part_f, ipcfr,itfr, estciv, año))
...
bT_cs<-arrange(bT_cs, nivel_m, nivel_f, part_m, part_f)
bT_sd<-arrange(bT_sd, nivel, part)

#Genero grupos como interacciones
bT_cs<-group_by(bT_cs, nivel_m, nivel_f, part_m, part_f)
bT_sd<-group_by(bT_sd, nivel, part)

#Grupos para parejas casadas
bT_cs<-mutate(bT_cs, grupos_cs=interaction(estciv,nivel_m,nivel_f,part_m,
                                           part_f,sep="_", lex.order=TRUE))
...
bT_sd<-mutate(bT_sd, grupos_sd=interaction(estciv,nivel,part, 
...
grupos<-read.table("C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/typesnk.txt", sep="\t")
...
write.table(format(tab1, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/r_ftotinc_adjnk_1.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(tab4, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/r_ftotinc_adjnk_4.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(ftab1, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/f_ftotinc_adjnk_1.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
write.table(format(ftab4, scientific = FALSE),file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/f_ftotinc_adjnk_4.txt",sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
...
#write.table(ing_esp_m1,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/wife_share_1.txt",sep="\t", col.names = F, row.names = F)
#write.table(ing_esp_m4,file="C:/Users/VictorF/Dropbox/Tesis Maestría/codes_ggksPandP/Output/wife_share_4.txt",sep="\t", col.names = F, row.names = F)
